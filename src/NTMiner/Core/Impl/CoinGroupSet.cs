...
namespace NTMiner.Core.Impl {
    public class CoinGroupSet : ICoinGroupSet {
        ...
        public CoinGroupSet(INTMinerRoot root) {
            _root = root;
            _root.ServerContext.BuildCmdPath<AddCoinGroupCommand>("添加币组", LogEnum.DevConsole,
                action: (message) => {
                    InitOnece();
            ...
            _root.ServerContext.BuildCmdPath<RemoveCoinGroupCommand>("移除币组", LogEnum.DevConsole,
                action: (message) => {
                    InitOnece();
