...
namespace NTMiner.Core.Kernels.Impl {
    public class PoolKernelSet : IPoolKernelSet {
        ...
        public PoolKernelSet(INTMinerRoot root) {
            _root = root;
            _root.ServerContext.BuildCmdPath<AddPoolKernelCommand>("处理添加矿池级内核命令", LogEnum.DevConsole,
                action: message => {
            ...
            _root.ServerContext.BuildCmdPath<RemovePoolKernelCommand>("处理移除矿池级内核命令", LogEnum.DevConsole,
                action: message => {
            ...
            _root.ServerContext.BuildCmdPath<UpdatePoolKernelCommand>("更新矿池内核", LogEnum.DevConsole,
                action: (message) => {
                    InitOnece();
