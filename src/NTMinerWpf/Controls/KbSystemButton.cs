...
namespace NTMiner.Controls {
    public class KbSystemButton : Button {
        ...
        public static readonly DependencyProperty KbSystemButtonSizeProperty =
            DependencyProperty.Register("KbSystemButtonSize", typeof(int), typeof(KbSystemButton), new PropertyMetadata(30));
        ...
        public static readonly DependencyProperty KbSystemButtonHoverBackgroundProperty =
            DependencyProperty.Register("KbSystemButtonHoverBackground", typeof(SolidColorBrush), typeof(KbSystemButton), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(50, 50, 50, 50))));
        ...
        public static readonly DependencyProperty KbSystemButtonForegroundProperty =
            DependencyProperty.Register("KbSystemButtonForeground", typeof(SolidColorBrush), typeof(KbSystemButton), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 255, 255, 255))));
        ...
        public static readonly DependencyProperty KbSystemButtonHoverForegroundProperty =
            DependencyProperty.Register("KbSystemButtonHoverForeground", typeof(SolidColorBrush), typeof(KbSystemButton), new PropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 255, 255, 255))));
