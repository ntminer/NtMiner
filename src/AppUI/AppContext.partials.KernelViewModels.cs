...
namespace NTMiner {
    public partial class AppContext {
        public class KernelViewModels : ViewModelBase {
            ...
            private void Init() {
                NTMinerRoot.Instance.On<KernelAddedEvent>("添加了内核后调整VM内存", LogEnum.DevConsole,
                    action: (message) => {
                ...
                NTMinerRoot.Instance.On<KernelRemovedEvent>("删除了内核后调整VM内存", LogEnum.DevConsole,
                    action: message => {
                ...
                NTMinerRoot.Instance.On<KernelUpdatedEvent>("更新了内核后调整VM内存", LogEnum.DevConsole,
                    action: message => {
