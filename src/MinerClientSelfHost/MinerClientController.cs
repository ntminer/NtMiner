...
namespace NTMiner {
    ...
    public class MinerClientController : ApiController, IMinerClientController, IShowMainWindow {
        ...
        public ResponseBase SetMinerProfileProperty([FromBody]SetMinerProfilePropertyRequest request) {
            ...
            try {
                VirtualRoot.WorkerEvent(WorkerEventChannel.MinerStudio, $"{VirtualRoot.WorkerEventFromMinerStudio}设置挖矿参数");
        ...
        public void OverClock() {
            VirtualRoot.WorkerEvent(WorkerEventChannel.MinerStudio, $"{VirtualRoot.WorkerEventFromMinerStudio}刷新超频");
