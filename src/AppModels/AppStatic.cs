    ...
    public static class AppStatic {
        ...
        public static string QQGroup {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "QQGroup", out ISysDicItem dicItem)) {
        ...
        public static Version MinAmdDriverVersion {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "MinAmdDriverVersion", out ISysDicItem dicItem)) {
        ...
        public static Version MinNvidiaDriverVersion {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "MinNvidiaDriverVersion", out ISysDicItem dicItem)) {
                    if (Version.TryParse(dicItem.Value, out Version version)) {
                        return version;
                    }
                }
        ...
        public static string DriverVersion {
            get {
                ...
                if (gpuSet.GpuType == GpuType.NVIDIA) {
                    var cudaVersion = gpuSet.Properties.FirstOrDefault(a => a.Code == Consts.CudaVersionSysDicCode);
                    if (cudaVersion != null) {
        ...
        public static ICommand JoinQQGroup { get; private set; } = new DelegateCommand(() => {
            ...
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "QQGroupJoinUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
        ...
        public static ICommand ShowHelp { get; private set; } = new DelegateCommand(() => {
            ...
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "HelpUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
        ...
        public static ICommand OpenOfficialSite { get; private set; } = new DelegateCommand(() => {
            string url = "http://ntminer.com/";
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "HomePageUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
        ...
        public static string OfficialSiteName {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "HomePageUrl", out ISysDicItem dicItem) && !string.IsNullOrEmpty(dicItem.Value)) {
        ...
        public static string AppMinerName {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "AppMinerName", out ISysDicItem dicItem)) {
                    return dicItem.Value;
                }
                return "开源矿工";
            }
        ...
        public static string AppMinerIntro {
            get {
                ...
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "AppMinerIntro", out ISysDicItem dicItem)) {
                    return dicItem.Value;
                }
                return "开源、开放、安全、专业、最高收益。QQ群863725136";
            }
        ...
        public static ICommand BusinessModel { get; private set; } = new DelegateCommand(() => {
            ...
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "BusinessModelUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
        ...
        public static ICommand OpenGithub { get; private set; } = new DelegateCommand(() => {
            ...
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "GithubUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
        ...
        public static ICommand OpenDiscussSite { get; private set; } = new DelegateCommand(() => {
            ...
            if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.ThisSystemSysDicCode, "DiscussUrl", out ISysDicItem dicItem)) {
                url = dicItem.Value;
            }
            Process.Start(url);
        });
