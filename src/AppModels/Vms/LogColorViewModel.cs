    ...
    public class LogColorViewModel : ViewModelBase {
        ...
        private ConsoleColor SpeedColor {
            get {
                ...
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(SpeedColor), out dicItem)) {
        ...
        private ConsoleColor TFPColor {
            get {
                ConsoleColor color = ConsoleColor.White;
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(TFPColor), out dicItem)) {
                    if (!dicItem.Value.TryParse(out color)) {
                        color = ConsoleColor.White;
                    }
                }
        ...
        private ConsoleColor SuccessColor {
            get {
                ConsoleColor color = ConsoleColor.White;
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(SuccessColor), out dicItem)) {
                    if (!dicItem.Value.TryParse(out color)) {
                        color = ConsoleColor.White;
                    }
                }
        ...
        private ConsoleColor FailColor {
            get {
                ConsoleColor color = ConsoleColor.White;
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(FailColor), out dicItem)) {
                    if (!dicItem.Value.TryParse(out color)) {
                        color = ConsoleColor.White;
                    }
                }
        ...
        private ConsoleColor ErrorColor {
            get {
                ConsoleColor color = ConsoleColor.White;
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(ErrorColor), out dicItem)) {
                    if (!dicItem.Value.TryParse(out color)) {
                        color = ConsoleColor.White;
                    }
                }
        ...
        private ConsoleColor InfoColor {
            get {
                ConsoleColor color = ConsoleColor.White;
                ISysDicItem dicItem;
                if (NTMinerRoot.Instance.SysDicItemSet.TryGetDicItem(Consts.LogColorSysDicCode, nameof(InfoColor), out dicItem)) {
                    if (!dicItem.Value.TryParse(out color)) {
                        color = ConsoleColor.White;
                    }
                }
