        ...
        static void Main(string[] args) {
            try {
                ...
                if (mutexCreated) {
                    ...
                    NotifyIcon = ExtendedNotifyIcon.Create(new System.Drawing.Icon(thisType.Assembly.GetManifestResourceStream(thisType, "logo.ico")), "NTMiner守护进程", isCanClose: DevMode.IsDebugMode);
