...
namespace NTMiner {
    ...
    public class ColumnsShowAddedOrUpdatedEvent : DomainEvent<IColumnsShow> {
    ...
    public class ColumnsRemovedEvent : DomainEvent<IColumnsShow> {
