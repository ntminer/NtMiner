...
namespace NTMiner.Views.Ucs {
    public partial class StartStopMineButton : UserControl {
        ...
        public static readonly DependencyProperty StartButtonBackgroundProperty =
            DependencyProperty.Register(nameof(StartButtonBackground), typeof(SolidColorBrush), typeof(StartStopMineButton), new PropertyMetadata(Util.TransparentBrush));
        ...
        public static readonly DependencyProperty StartButtonForegroundProperty =
            DependencyProperty.Register(nameof(StartButtonForeground), typeof(SolidColorBrush), typeof(StartStopMineButton), new PropertyMetadata(Util.TransparentBrush));
