...
namespace NTMiner.Gpus.Nvapi.Native.Interfaces.GPU
{
    ...
    public interface IPerformanceStatesInfo
    {
        ...
        /// </summary>
        IDictionary<PerformanceStateId, IPerformanceStatesClock[]> PerformanceStatesClocks { get; }

        /// <summary>
        ///     Gets a dictionary of valid and available performance states and their voltage information as an array
        /// </summary>
        IDictionary<PerformanceStateId, IPerformanceStatesVoltage[]> PerformanceStatesVoltages { get; }
    }
}