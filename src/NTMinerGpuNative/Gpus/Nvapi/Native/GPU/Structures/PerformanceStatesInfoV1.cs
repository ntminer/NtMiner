...
namespace NTMiner.Gpus.Nvapi.Native.GPU.Structures
{
    ...
    public struct PerformanceStatesInfoV1 : IInitializable, IPerformanceStatesInfo
    {
        ...
        /// <inheritdoc />
        public IDictionary<PerformanceStateId, IPerformanceStatesVoltage[]> PerformanceStatesVoltages
        {
            get => new Dictionary<PerformanceStateId, IPerformanceStatesVoltage[]>(
        ...
        /// <inheritdoc />
        IDictionary<PerformanceStateId, IPerformanceStatesClock[]> IPerformanceStatesInfo.
            PerformanceStatesClocks
        {
            get
            {
