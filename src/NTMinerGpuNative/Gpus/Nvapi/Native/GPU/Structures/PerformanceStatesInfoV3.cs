...
namespace NTMiner.Gpus.Nvapi.Native.GPU.Structures
{
    ...
    public struct PerformanceStatesInfoV3 : IInitializable, IPerformanceStatesInfo
    {
        ...
        /// </summary>
        public IDictionary<PerformanceStateId, PerformanceStatesInfoV2.PerformanceState.PerformanceStatesVoltage[]>
        ...
        /// <inheritdoc />
        IDictionary<PerformanceStateId, IPerformanceStatesVoltage[]> IPerformanceStatesInfo.PerformanceStatesVoltages
        {
            get
            {
        ...
        /// </summary>
        public IDictionary<PerformanceStateId, PerformanceStatesInfoV2.PerformanceState.PerformanceStatesClock[]>
        ...
        /// <inheritdoc />
        IDictionary<PerformanceStateId, IPerformanceStatesClock[]> IPerformanceStatesInfo.PerformanceStatesClocks
        {
            get
            {
