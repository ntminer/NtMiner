...
namespace NTMiner.Gpus.Nvapi.Native.GPU.Structures
{
    ...
    public struct PerformanceStates20InfoV1 : IInitializable, IPerformanceStates20Info
    {
        ...
        /// </summary>
        public IDictionary<PerformanceStateId, PerformanceStates20BaseVoltageEntryV1[]> Voltages
        {
            get
            {
        ...
        /// <inheritdoc />
        IDictionary<PerformanceStateId, IPerformanceStates20VoltageEntry[]> IPerformanceStates20Info.Voltages
        {
            get
            {
