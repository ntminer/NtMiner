...
namespace NTMiner.Gpus.Nvapi.Native.GPU.Structures
{
    ...
    public struct PerformanceStatesInfoV2 : IInitializable, IPerformanceStatesInfo
    {
        ...
        /// </summary>
        public IDictionary<PerformanceStateId, PerformanceState.PerformanceStatesVoltage[]>
        ...
        /// </summary>
        public IDictionary<PerformanceStateId, PerformanceState.PerformanceStatesClock[]>
